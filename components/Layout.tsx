      ...
      <main classname="flex-1 overflow-hidden relative">
        ...
        <div classname="fixed bottom-6 left-6 z-[200] flex items-center gap-3">
          <div classname="flex items-center gap-2 px-3 py-1.5 bg-black/60 backdrop-blur-md rounded-full border border-white/5 opacity-60 hover:opacity-100 transition-opacity">
            <div classname="{`w-1.5" h-1.5="" rounded-full="" transition-colors="" duration-500="" ${="" isonline="" ?="" 'bg-green-500="" shadow-[0_0_8px_rgba(34,197,94,0.5)]'="" :="" 'bg-orange-500="" shadow-[0_0_8px_rgba(249,115,22,0.5)]'="" }`}=""/>
          ...
          {/* Sync Error Alert */}
          {syncError && (
            <motion.div initial="{{" opacity:="" 0,="" x:="" -10="" }}="" animate="{{" opacity:="" 1,="" x:="" 0="" }}="" classname="flex items-center gap-2 px-3 py-1.5 bg-red-500/10 backdrop-blur-md rounded-full border border-red-500/20 text-red-500">
              <alertcircle size="{12}"/>
